...
InlineKeyboardButton("Tʀʏ Aɢᴀɪɴ 🔃", URL=f"http://t.me/vishnu_v3_bot?start")
                        ]
                    ]
                ),
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/+o1KCimZSM2dkZjc1'>CLICK HERE FOR SUPPORT </a></b>",
                
                disable_web_page_preview=True)
            return
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://graph.org/file/9f9a05d3a5298fb347096.jpg",
...
InlineKeyboardButton("Tʀʏ Aɢᴀɪɴ 🔃", URL=f"http://t.me/vishnu_v3_bot?start")
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [VISHNU](https://telegram.me/vis_hnu_bot).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEVELOPER", url="https://t.me/VIS_HNU_BOT")],
                [InlineKeyboardButton("💥 Our SERIAL GROUP", url="https://t.me/+pv6pyymMy1tmZGY1")]
            ]
        )
    )
